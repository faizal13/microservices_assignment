package com.rakbank.expensems.exceptionHandler;
...
import com.rakbank.expensems.model.ErrorMessage;
import com.rakbank.expensems.model.errormodels.ApiErrorsView;
import com.rakbank.expensems.model.errormodels.ApiFieldError;
import com.rakbank.expensems.model.errormodels.ApiGlobalError;
import com.rakbank.expensems.model.errormodels.FieldErrorResponse;
import com.rakbank.expensems.utils.Constant;
import com.rakbank.expensems.utils.ResponseUtils;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<CustomResponse<Object>> handleException(Throwable ex, WebRequest webRequest) {
		...
		int statusCode = 500;
		HttpServletRequest request = ((ServletWebRequest) webRequest).getRequest();
		CustomResponse<Object> customResponse = ResponseUtils.getCustomResponse(statusCode,  new ErrorMessage(ex.getMessage(), ex.getLocalizedMessage()),
	...
	public ResponseEntity<CustomResponse<Object>> handleBudgetServiceException(ExpenseServiceException e, WebRequest webRequest) {
		HttpServletRequest request = ((ServletWebRequest) webRequest).getRequest();
